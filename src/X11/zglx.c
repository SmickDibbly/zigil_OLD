...
#include "dibfmt_put.h"

#include "../zigil_mem.h"
#include "zglx.h"
#include "zglx_macro_str.h"
#include "zglx_ping.h"
#include "zglx_event.h"
...
#define INCLUDE_SRC
#include "zglx_printstruct.c" /* Printers of X11 structs; for debugging. */
#undef INCLUDE_SRC
#include "verbosity.h" /* Thin wrappers around stdio.h print functions; for
                              easy stripping. */
...
zgl_Result zgl_SetWindowTitle(char const *title) {
    XChangeProperty(x11_info.display, x11_info.win_info.win, XA_WM_NAME, XA_STRING, 8, PropModeReplace, (unsigned char *)title, strlen(title));
    return 0;
}
